...
class RecetasAdapter(private var recetasList: MutableList<Receta>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.view_receta, parent, false)
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view){
        ...
        fun bind(receta: Receta){
            ...
            binding.viewCompleted.isChecked = receta.iscomplited
        }

        fun setListener(item: Receta) {
            binding.viewCompleted.setOnClickListener { listener.onComplitedReceta(item) }
